...
# ==== Import Libraries After Logging Configuration ====
import streamlit as st
import asyncio
from autogen import AssistantAgent, UserProxyAgent
import os
...
# ==== Initialize the LLMChain with Memory ====
llm_chain = LLMChain(llm=llm, prompt=prompt, memory=memory)

# ==== Define answer_question Function ====
def answer_question(question: str) -> str:
    """
    Answer a question based on HIV PrEP knowledge base, utilizing conversation history.
...
# ==== Initialize Event Loop Once ====
# Removed custom event loop management to avoid conflict with Streamlit's loop
